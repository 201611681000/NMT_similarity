...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        # fmt: off
        parser.add_argument('--ffn-net-hidden-size', type=int, metavar='N',
                            help='ffnetwork embedding dimension')
        parser.add_argument('--bert-hidden-size', type=int, metavar='N',
                            help='ffnetwork embedding dimension')
    ...
    def ffnetwork(self,input_tensor):
        return self.decoder.through_ffnet(input_tensor)
        #self.decoder()
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.ffn_net_src = nn.Sequential(
            Linear(args.bert_hidden_size,args.ffn_net_hidden_size),
            nn.ReLU(),
    ...
    def through_ffnet(self,input_tensor, flag=None):
        if flag == 'src':
            return self.ffn_net_src(input_tensor)
        elif flag == 'cand':
            return self.ffn_net_cand(input_tensor)
        return self.ffn_net_ce(input_tensor)

...
def add_generation_args(parser):
    ...
    add_common_eval_args(group)
    # fmt: off
    group.add_argument('--beam-size', default=5, type=int, metavar='N',
                       help='beam size')
    group.add_argument('--nbest', default=1, type=int, metavar='N',
                       help='number of hypotheses to output')
    group.add_argument('--usebleu', action='store_true', default=False, help = "if set, use bleu to choose the best translation.")
    group.add_argument('--usebert', action='store_true', default=False, help = "if set, use bert score to choose the best translation.")
